Feature: Testing the To From Related Party Page

  Scenario Outline: testing the From a related party page with valid data
    Given  I am on Balance Sheet Funds and Other Disclosure Section
    When   I navigate to Related Party Transactions From a related party section in BSFAOD
...
#     data to be provided.
  ...
  Scenario Outline: testing the From a related party page with invalid data
    Given  I am on Balance Sheet Funds and Other Disclosure Section
    When   I navigate to Related Party Transactions From a related party section in BSFAOD
    When   I select from dropdown "<ddValue>" in BSFAOD
    And    I enter value in instance "<instance>" and column Number of related parties with "<v1>" and column Value with "<v2>" in BSFAOD
...
#     data to be provided.
  ...
  Scenario Outline: testing the From a related party page with All Financial Data Error
    Given  I am on Balance Sheet Funds and Other Disclosure Section
    When   I navigate to Related Party Transactions From a related party section in BSFAOD
    When   I select from dropdown "<ddValue>" in BSFAOD
    And    I enter value in instance "<instance>" and column Number of related parties with "<v1>" and column Value with "<v2>" in BSFAOD
...
#     data to be provided.
  ...
  Scenario Outline: testing the From a related party page with Invalid Data  Error
    Given  I am on Balance Sheet Funds and Other Disclosure Section
    When   I navigate to Related Party Transactions From a related party section in BSFAOD
    When   I select from dropdown "<ddValue>" in BSFAOD
    And    I enter value in instance "<instance>" and column Number of related parties with "<v1>" and column Value with "<v2>" in BSFAOD
