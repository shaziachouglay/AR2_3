...
public class RestrictedFixedAssets extends CommonMethods {

    private String pageName="Restricted Fixed Asset";

    @FindBy(xpath = "//div[@class='opa-main-panel']")
    private WebElement page_body;

    @FindBy(how= How.XPATH , using = "//div[@class='opa-screen-title'][contains(.,'Restricted Fixed Asset')]")
    ...
    public void setValueInFieldByRowNameAndColumnName(RowConstants row, ColumnConstant column, String inputValue){
        ...
        switch (column){
            ...
            case OtherActivities:
                ...
                break;
            case Total:
                columnCount=columnCount+columnIncrementer+4;
                break;
        }
    ...
    public enum ColumnConstant{
        DfeAndEsfaCapitalGrants, DfeGroup,OtherActivities,Total
    }
