...
public class AUC_TFA_Cost extends CommonMethods{

    private String pageName="AUC TFA Cost";
     ...
     public void setValueInFieldByRowNameAndColumnNameInAUC_TFA_CostPage(RowConstants row,ColumnConstant column, String inputValue){
        ...
        switch(row){
            ...
            case Reclassifications:                                                     rowCount=rowIncrementer+14;
                break;
            case TotalClosingBalance:                                                   rowCount=rowIncrementer+15;
                break;
        }
        ...
        switch (column){
            ...
            case ComputerEquipment:                                                     columnCount=columnIncrementer+6;
                break;
        case AssetsUnderConstruction:                                                   columnCount=columnIncrementer+7;
            break;
