...
public class Academies_Impairments extends CommonMethods {
    private String pageName="LNB Academies Impairments ";
    ...
    public void setValueInFieldByRowNameAndColumnName(RowConstants row, ColumnConstant column, String inputValue){
        ...
        switch(row){
            ...
            case ReleasedInPeriod:                                                      rowCount=rowIncrementer+4;
                break;
            case TransferredInOnExistingAcademiesLeavingTheTrust:                       rowCount=rowIncrementer+5;
                break;
            case TransferredOutOnExistingAcademiesLeavingTheTrust:                      rowCount=rowIncrementer+6;
                break;
            case AtCloseOfPeriod:                                                       rowCount=rowIncrementer+7;
                break;
        }
        ...
        switch (column){
            ...
            case LeaseholdImprovements:                                                 columnCount=columnIncrementer+3;
                break;
            case AssetUnderContruction:                                                 columnCount=columnIncrementer+4;
                break;
    ...
    public enum RowConstants{
        ...
        ChargedInPeriod,
        ReleasedInPeriod,
        TransferredInOnExistingAcademiesLeavingTheTrust,
