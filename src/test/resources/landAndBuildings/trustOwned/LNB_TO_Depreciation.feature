Feature: Testing the Land and Buildings Trust Owned Depreciation Page
  ...
  Scenario: Reference Testing the Land and Buildings Trust Owned Depreciation Page

    Given I am on Land and Buildings Section
    And   I have navigated to the Trust Owned Depreciation Page
    Then I see the correct references are displayed for "lnb_to_Depriciation" page of type "Table"
...
#    Then  I see value in row Transferred out on existing Academies joining the Trust and column Total is "<v2>" in TO_Depreciation page
  ...
  @smoke
  Scenario Outline: Testing the Land and Buildings Trust Owned Depreciation Page with Invalid Credentials
  ...
  @smoke
  Scenario Outline: Testing the Land and Buildings Trust Owned Depreciation Page with Errors Invalid Data Format
