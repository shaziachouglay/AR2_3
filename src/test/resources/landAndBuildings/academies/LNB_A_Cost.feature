Feature: Testing the Land and Buildings Academies Cost Page
  ...
  @smoke @LNBacademiesCost
  Scenario Outline: Testing the Land and Buildings Academies Cost Page with INVALID Credentials
  ...
  @smoke @LNBacademiesCost
  Scenario Outline: Testing the Land and Buildings Academies Cost Page for Errors All Financial Data
  ...
  @smoke @LNBacademiesCost
  Scenario Outline: Testing the Land and Buildings Academies Cost Page for Errors Invalid Number Format
