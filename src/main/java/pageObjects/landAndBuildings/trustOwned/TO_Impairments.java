...
public class TO_Impairments extends CommonMethods {
    ...
    private String pageName="LNB Trust Owned Impairments ";
    ...
    public void setValueInFieldByRowNameAndColumnName(RowConstants row, ColumnConstant column, String inputValue){
        ...
        switch(row){
            ...
            case ReleasedInPeriod:                                                      rowCount=rowIncrementer+4;
                break;
            case TransferredOutOnExistingAcademiesLeavingTheTrust:                      rowCount=rowIncrementer+5;
                break;
            case AtCloseOfPeriod:                                                       rowCount=rowIncrementer+6;
                break;
        }
