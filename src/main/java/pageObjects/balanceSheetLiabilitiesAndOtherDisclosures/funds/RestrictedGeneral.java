...
public class RestrictedGeneral extends CommonMethods {


    private String pageName="Restricted General";

    @FindBy(xpath = "//div[@class='opa-main-panel']")
    private WebElement page_body;

    @FindBy(how= How.XPATH , using = "//div[@class='opa-screen-title'][contains(.,'Restricted General')]")
    ...
    public void setValueInFieldByRowNameAndColumnName(RowConstants row, ColumnConstant column, String inputValue){
        ...
        switch (column){
            ...
            case DFEAndESFAGeneralAnnualGrants:
                columnCount=columnCount+1;
                break;
            case OtherDFEAndESFGrants:
    ...
    public enum ColumnConstant{
        DFEAndESFAGeneralAnnualGrants, OtherDFEAndESFGrants, DFEGroup, PensionReserve, Other, Total
    }
